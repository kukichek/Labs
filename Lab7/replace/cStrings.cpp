...
char* replace(char* initialString, char* str1, char* str2) {
	char *positionOfSubstr = strstr(initialString, str1);
	char* terminalStringBegin = new char[1000];
	terminalStringBegin[positionOfSubstr - initialString] = '\0';
	strncpy(terminalStringBegin, initialString, positionOfSubstr - initialString);

	char* terminalStringEnd = new char[1000];
	strcpy(terminalStringEnd, positionOfSubstr + strlen(str1));

	strcat(terminalStringBegin, str2);
	strcat(terminalStringBegin, terminalStringEnd);
